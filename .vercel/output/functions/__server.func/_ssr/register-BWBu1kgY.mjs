...
import { T as ShieldCheck, X as LoaderCircle, _ as Sparkles, ct as Globe, dt as Eye, ft as EyeOff, m as Store } from "../_libs/lucide-react.mjs";
import { t as Button } from "./button-Cr1ZI0g1.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { a as t, o as useLocale } from "./locale-BbUoQ0KM.mjs";
import { t as Route } from "./register-BnXiUA0R.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/register-BWBu1kgY.js
...
function Register() {
	...
	const getPasswordStrength = (pass) => {
		...
		if (score <= 1) return {
			score,
			label: "Weak (add letters, numbers & special chars)",
			color: "bg-rose-500",
			text: "text-rose-500"
		};
		if (score === 2) return {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								...
								children: t("auth_register_title", language) || "Create an account"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-2 text-sm text-slate-500",
								children: "Join Saloree to shop or start selling globally today."
							})
						]
					}),
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: t("full_name_label", language) || "Full name"
									...
									password && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												className: `font-medium ${strength.text}`,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-4 animate-spin" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Creating account..." })]
