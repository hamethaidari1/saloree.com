...
import { A as Save, H as Megaphone, J as Layers, O as Share2, Q as Image, S as SlidersVertical, V as Menu, Z as Info, at as Footprints, nt as Grid3x3, st as Eye, x as Smartphone, y as Sparkles, yt as ChevronLeft, z as Monitor } from "../_libs/lucide-react.mjs";
import { t as Button } from "./button-Cr1ZI0g1.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as Route } from "./seller.theme-customizer-BEd-SBrM.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/seller.theme-customizer-CFuw6V_t.js
...
function CenterPreview({ settings, viewMode }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "text-[10px]",
					style: { color: mutedTextColor },
					children: settings.footer_text || "© 2026 My Store"
				})]
			})
		]
	});
...
function ThemeCustomizer() {
	...
	const saveMutation = useMutation({
		mutationFn: async () => {
			...
			if (installData?.store_theme_settings?.length > 0) {
				const { error } = await supabase.from("store_theme_settings").update(payload).eq("theme_installation_id", installationId);
				if (error) throw error;
			} else {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						activeSection === "footer" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "space-y-4",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
