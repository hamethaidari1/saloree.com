...
import { F as Pen, I as Palette, d as Trash2, mt as Ellipsis, pt as ExternalLink, y as Smartphone, yt as Copy, z as Monitor } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/seller.themes-DMIkP2VO.js
...
function ThemePreviewModal({ theme, open, onClose, onAdd, adding, isInstalled }) {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							disabled: true,
							children: "Installed"
						}) : theme.isFree ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							size: "sm",
							disabled: adding,
							onClick: onAdd,
...
function SellerThemes() {
	...
	const [buyModalTheme, setBuyModalTheme] = (0, import_react.useState)(null);
		...
		if (store?.id && !installationsLoading && rawInstallations.length === 0) {
			const autoInstallDefault = async () => {
				try {
					...
					const { data: existing } = await supabase.from("store_theme_installations").select("id").eq("store_id", store.id).eq("theme_id", defaultTheme.id).maybeSingle();
					if (existing) {
	...
	const addThemeMutation = useMutation({
		mutationFn: async (theme) => {
			...
			const { data: existing } = await supabase.from("store_theme_installations").select("id").eq("store_id", store.id).eq("theme_id", theme.id).maybeSingle();
			if (existing) throw new Error("__ALREADY_INSTALLED__");
			const { data: inst, error: instErr } = await supabase.from("store_theme_installations").insert({
				store_id: store.id,
				theme_id: theme.id,
				name: theme.name,
		...
		onError: (err) => {
			if (err.message === "__ALREADY_INSTALLED__") toast.info("Theme already installed.");
			else toast.error("Failed to add theme: " + err.message);
			setAddingId(null);
		}
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							children: "Explore template designs from the Saloree Theme Store."
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					(() => {
						const filteredThemes = BUILTIN_THEMES.filter((theme) => {
							if (searchQuery.trim()) {
								...
								if (!theme.name.toLowerCase().includes(q) && !theme.description.toLowerCase().includes(q) && !theme.category.toLowerCase().includes(q)) return false;
							}
							if (activeFilter === "free") return theme.isFree;
							if (activeFilter === "premium") return !theme.isFree;
							if (activeFilter !== "all") return theme.category.toLowerCase() === activeFilter.toLowerCase();
							return true;
						});
						if (filteredThemes.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-center py-16 border rounded-2xl bg-muted/10 text-muted-foreground",
							children: "No themes match your search or filter criteria."
						});
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: filteredThemes.map((theme) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "relative aspect-video overflow-hidden border-b bg-muted/20",
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-1 rounded-full bg-slate-900/90 text-white shadow-sm",
													children: theme.category
												}), theme.isPopular && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-1 rounded-full bg-amber-500 text-slate-950 shadow-sm",
													children: "★ Most Popular"
												})]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "absolute top-3 right-3 z-10",
												children: theme.isFree ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-1 rounded-full bg-green-500 text-white shadow-sm",
													children: "Free"
												}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-1 rounded-full bg-indigo-600 text-white shadow-sm",
													children: "✦ Premium"
												})
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
														...
														className: "font-extrabold text-base text-slate-800 shrink-0",
														children: theme.isFree ? "Free" : `$${theme.price.toFixed(2)}`
													})]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-[11px] font-semibold text-indigo-600/95 italic bg-indigo-500/5 p-2 rounded-lg border border-indigo-500/10",
													children: theme.benefit
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "pt-2",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground/80 mb-1.5",
														children: "Includes"
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "grid grid-cols-2 gap-x-2 gap-y-1 text-[11px] text-slate-600",
														children: theme.features.map((feat) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												...
												onClick: () => setPreviewTheme(theme),
												children: "Preview"
											}), installedThemeIds.has(theme.id) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												size: "sm",
												...
												children: addingId === theme.id ? "Adding…" : "Add theme"
											}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												size: "sm",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				open: !!buyModalTheme,
				onOpenChange: (v) => !v && setBuyModalTheme(null),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					className: "sm:max-w-md text-center py-6",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mx-auto w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 text-xl mb-3",
								children: "✦"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
								className: "text-lg font-bold text-center",
								children: "Theme purchases are coming soon"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogDescription, {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", {
										...
										children: ["$", buyModalTheme?.price.toFixed(2)]
									}),
									"."
								]
							})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "py-2 text-xs text-muted-foreground bg-slate-50 border rounded-lg p-3 my-2",
							children: "Payment integration is currently disabled during development. Premium theme installations will be unlocked once checkout options go live."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogFooter, {
							className: "sm:justify-center",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "default",
								onClick: () => setBuyModalTheme(null),
								className: "h-9 px-6 font-bold cursor-pointer",
								children: "Got it"
							})
						})
					]
