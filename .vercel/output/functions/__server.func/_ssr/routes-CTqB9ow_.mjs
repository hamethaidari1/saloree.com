...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CTqB9ow_.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function FlashDeals({ products, isLoading }) {
	const deals = products.slice(0, 4);
	if (isLoading || deals.length === 0) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "rounded-3xl border border-red-100 bg-gradient-to-br from-red-50 via-white to-orange-50 p-4 shadow-soft sm:p-6",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-2 inline-flex items-center gap-2 rounded-full bg-red-100 px-3 py-1 text-xs font-bold text-red-600",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flame, { className: "size-4" }), "Flash Deals"]
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Hot deals selected for today. Grab them before they are gone."
				})
			] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hidden items-center gap-2 rounded-full bg-white px-4 py-2 text-xs font-bold text-gray-700 shadow-sm sm:flex",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-4 text-red-500" }), "Ends soon"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					asChild: true,
					className: "rounded-full bg-[#FF3B3B] hover:bg-[#E03030]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/marketplace",
						children: ["View all", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "ml-2 size-4" })]
					})
				})]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid grid-cols-2 gap-4 lg:grid-cols-4",
			children: deals.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductCard, { product }, product.id))
		})]
	});
}
var AUTOPLAY_MS = 3e3;
...
function Index() {
	...
	const { data: featuredProducts = [], isLoading: loadingFeatured } = useQuery({
		...
		queryFn: async () => {
			...
			if (data && data.length > 0) return data.filter((p) => p !== null && p !== void 0 && p.slug !== null && p.slug !== void 0);
			...
			return (fallback ?? []).filter((p) => p !== null && p !== void 0 && p.slug !== null && p.slug !== void 0);
		}
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FlashDeals, {
				products: featuredProducts,
				isLoading: loadingFeatured
			}),
			showCategories && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "space-y-6",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
